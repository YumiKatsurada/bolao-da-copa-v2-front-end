...
class PalpiteForm extends React.Component {
  constructor() {
      ...
      this.state = {
          ...
          campoClassNameEmail: 'form-control',
          campoClassNameSenha: 'form-control',
          campoClassNameNome: 'form-control',
          campoClassNameTelefone: 'form-control',
          campoClassNameVice: 'form-control',
          campoClassNameCampeao: 'form-control',
          campoClassNameSenhaConfirmar: 'form-control',
  ...
  mostrarCampoInvalidoEmail() { this.setState({ campoClassNameEmail: 'form-control alert alert-danger', }); }
  mostrarCampoInvalidoNome() { this.setState({ campoClassNameNome: 'form-control alert alert-danger', }); }
  mostrarCampoInvalidoSenha() { this.setState({ campoClassNameSenha: 'form-control alert alert-danger', }); }
  mostrarCampoInvalidoVice() { this.setState({ campoClassNameVice: 'form-control alert alert-danger', }); }
  mostrarCampoInvalidoCampeao() { this.setState({ campoClassNameCampeao: 'form-control alert alert-danger', }); }
  mostrarCampoInvalidoTelefone() { this.setState({ campoClassNameTelefone: 'form-control alert alert-danger', }); }
  mostrarCampoInvalidoConfirmar() { this.setState({ campoClassNameSenhaConfirmar: 'form-control alert alert-danger', }); }
  mostrarCampoValido() { this.setState({
                                          campoClassNameEmail: 'form-control',
                                          campoClassNameSenha: 'form-control',
                                          campoClassNameNome: 'form-control',
                                          campoClassNameTelefone: 'form-control',
    ...
    validarCampo({ nome, valor = null }) {
        ...
        if (nome === 'email') {
            if (!/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/.test(valor)) {
                this.mostrarCampoInvalidoEmail();
                return 'E-mail está em formato incorreto';
            }
        } else if (nome === 'senha') {
            if (valor.length === 0) {
                this.mostrarCampoInvalidoSenha();
            ...
            if (valor.length === 0) {
                this.mostrarCampoInvalidoVice();
                return 'Vice não pode ser vazio';
            }
            if (valor === this.state.campeao) {
                this.mostrarCampoInvalidoCampeao();
                this.mostrarCampoInvalidoVice();
            ...
            if (valor === '') {
                if (nome === 'nome')
                  this.mostrarCampoInvalidoNome();
                if (nome === 'telefone')
                  this.mostrarCampoInvalidoTelefone();
                if(nome === 'campeao')
                  this.mostrarCampoInvalidoCampeao();
            ...
            if (this.state.usuarioEncontrado === null && this.state.estado.botaoConfirmarPalpiteVisivel) {
                ...
                if (valor !== senha) {
                    this.mostrarCampoInvalidoConfirmar();
                    return 'Confirmação da senha não confere';
                }
            }
        }
        //mostrarCampoValido
        this.mostrarCampoValido();
        return '';
                ...
                <div className="col-lg-12 text-center">
                    ...
                    <form className="form-horizontal" name="formPalpite">
                        ...
                        <div className="form-group">
                            ...
                            <input type="email"
                                className={this.state.campoClassNameEmail}
                                name="email"
                                label="E-mail"
                                value={this.state.email}
                                onChange={(event) => this.handleUserInput(event)}
                                onBlur={() => this.handleEmailChanged()}></input>
                            ...
                            <div className="col-sm-4">
                            <input type="password"
                                className={this.state.campoClassNameSenha}
                                name="senha"
                                label="Senha"
                            ...
                            <span className="text text-danger">{this.state.mensagensValidacao['senha']}</span>                            </div>
                        </div>
                        <div className="form-group">
                            <label className="col-sm-2 control-label" htmlFor="nome">Nome completo</label>
                            <div className="col-sm-10">
                                <input type="text"
                                    className={this.state.campoClassNameNome}
                                    name="nome"
                                    label="Nome"
                        ...
                        <div className="form-group">
                            ...
                            <div className="col-sm-4">
                                <input type="text"
                                    className={this.state.campoClassNameTelefone}
                                    name="telefone"
                                    label="Telefone"
                                    disabled={this.state.estado.camposDadosPessoaisDesabilitados}
                        ...
                        <div className={this.state.estado.camposDadosPalpiteDestaque ? 'form-group has-success' : 'form-group'}>
                            ...
                            <div className="col-sm-4">
                                <input type="text"
                                    className={this.state.campoClassNameCampeao}
                                    name="campeao"
                                    label="Campeão"
                            ...
                            <div className="col-sm-4">
                              {this.state.estado.campoConfirmacaoSenhaVisivel && (
                                  <input type="password"
                                      className={this.state.campoClassNameSenhaConfirmar}
                                      name="confirmarSenha"
                        ...
                        <div className={this.state.estado.camposDadosPalpiteDestaque ? 'form-group has-success' : 'form-group'}>
                            ...
                            <div className="col-sm-4">
                                <input type="text"
                                    className={this.state.campoClassNameVice}
                                    name="vice"
                                    label="Vice"
                                    disabled={this.state.estado.camposDadosPalpiteDesabilitados}
